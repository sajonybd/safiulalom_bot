...
import { FileText, ArrowLeft, Gavel, Scale, HelpCircle } from "lucide-react";
        ...
        <div className="space-y-12 text-foreground/80 leading-relaxed">
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-foreground flex items-center gap-3">
              <FileText className="w-6 h-6 text-primary/60" /> {t("terms_reg_title")}
            </h2>
            <p>
              {t("terms_reg_desc")}
            </p>
            <ul className="list-disc pl-6 space-y-2 marker:text-primary">
              <li>{t("terms_reg_item_1")}</li>
              <li>{t("terms_reg_item_2")}</li>
              <li>{t("terms_reg_item_3")}</li>
              <li>{t("terms_reg_item_4")}</li>
            </ul>
          </section>

          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-foreground flex items-center gap-3">
              <HelpCircle className="w-6 h-6 text-primary/60" /> {t("terms_ai_title")}
            </h2>
            <p>
              {t("terms_ai_desc")}
            </p>
            <ul className="list-disc pl-6 space-y-2 marker:text-primary">
              <li>{t("terms_ai_item_1")}</li>
              <li>{t("terms_ai_item_2")}</li>
              <li>{t("terms_ai_item_3")}</li>
            </ul>
          </section>

          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-foreground flex items-center gap-3">
              <Scale className="w-6 h-6 text-primary/60" /> {t("terms_use_title")}
            </h2>
            <p>
              {t("terms_use_desc")}
            </p>
          ...
          <section className="p-8 rounded-3xl bg-muted/30 border border-border/50 space-y-4 backdrop-blur-sm">
            <h3 className="text-lg font-bold text-foreground">{t("terms_questions_title")}</h3>
            <p className="text-sm text-muted-foreground">
              {t("terms_questions_desc").split(/(\[.*?\]\(.*?\))/g).map((part, i) => {
